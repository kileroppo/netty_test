package com.example.demo0713.sqltest.until;
...
//        genrateBirthDay();
    ...
    public static HashSet<String> makehunderName(int length) {
        HashSet<String> set = new HashSet<>(10100);
    ...
    public static List<String> genrateBirthDay(int length) {
        List<String> birdayLists = new ArrayList<>();
        for (int i =0; i < length; i++){
            ...
            birdayLists.add(randomBirthDate.toString());
        }
        return birdayLists;
    }
